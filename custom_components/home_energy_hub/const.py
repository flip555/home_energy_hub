...
SENSOR_UNITS = {
    ...
    "charge_overcurrent_delay_settings": "s",
    ...
    "remaining_capacity_protection_settings": "%",
    "interval_charge_capacity_settings": "%",
    "cycle_cumulative_capacity_settings": "%",
    "soc_ah_settings": "Ah",
}
